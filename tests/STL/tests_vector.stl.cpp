...
std::vector<int>::size_type default_capacity = 0;
std::vector<int>::size_type five_capacity = 5;

typedef std::vector<int>::iterator int_iterator;
typedef std::vector<std::string>::iterator string_iterator;
typedef std::vector<int>::const_iterator int_const_iterator;
typedef std::vector<std::string>::const_iterator string_const_iterator;
typedef std::vector<int>::reverse_iterator int_riterator;
typedef std::vector<std::string>::reverse_iterator string_riterator;
...
TEST(TestVectorIterator, TestVectorIteratorBegin) {
	...
	std::vector<int> const vec3(array1, array1 + 5);
	std::vector<std::string> vec4(array2, array2 + 5);
...
TEST(TestVectorIterator, TestVectorIteratorEnd) {
	...
	std::vector<int> const vec3(array1, array1 + 5);
	std::vector<std::string> const vec4(array2, array2 + 5);
...
TEST(TestVectorCapacity, TestVectorSize) {
	...
	int array1[] = {1, 2, 3, 4, 5};
	std::vector<int> vec2(array1, array1 + 5);
	EXPECT_EQ(vec2.size(), 5);
...
TEST(TestVectorElementAccess, TestVectorElementAccessOperator) {
	...
	std::vector<int> const vec2(array, array + 5);
	for (int i = 0; i < 5; i++)
...
TEST(TestVectorNonMemberFunctionOverloads, TestVectorRelationalOperators) {
	...
	std::vector<int> const vec2(3, 100);
	std::vector<int> vec3(3, 200);
	std::vector<int> const vec4(5, 100);
